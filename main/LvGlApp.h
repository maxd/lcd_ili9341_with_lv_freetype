...
#ifndef LCD_ILI9341_LVGLAPP_H
#define LCD_ILI9341_LVGLAPP_H
...
private:
    ...
    static void driverMonitorCallback(_disp_drv_t *displayDriver, uint32_t time, uint32_t updatedPixels);
};


#endif //LCD_ILI9341_LVGLAPP_H
